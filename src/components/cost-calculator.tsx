    ...
    <section className="py-24 relative">
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-6">
          ...
          {/* Lurus — accent highlight */}
          <motion.div
            {...fadeInUp}
            className="card card-spotlight p-6 md:p-7 relative overflow-hidden"
            style={{
              borderColor: "rgba(255, 93, 31, 0.35)",
              background:
                "linear-gradient(135deg, rgba(255,93,31,0.06) 0%, var(--color-surface) 60%)",
              boxShadow: "0 0 40px rgba(255, 93, 31, 0.08)",
            }}
          >
            <div className="flex items-center justify-between mb-4">
        ...
        <motion.div
          ...
          style={{
            borderColor: "rgba(255, 93, 31, 0.20)",
            background:
              "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(255,93,31,0.05) 0%, transparent 70%), var(--color-surface)",
          }}
        >
          <p className="eyebrow mb-3" style={{ color: "var(--color-accent)", opacity: 0.7 }}>
            YOUR SAVINGS
          </p>
          <div className="flex flex-col md:flex-row items-baseline justify-center gap-3 md:gap-5">
            ...
            <span
              className="text-5xl md:text-7xl font-bold font-mono tabular-nums leading-none"
              style={{ color: "var(--color-accent)" }}
            >
